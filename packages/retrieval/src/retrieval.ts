...
import { getCorpusById, loadCorpus, type CorpusReference } from "./corpus";
...
export type RetrievedEvidence = RetrievedSource;
...
export class CorpusRetriever implements Retriever {
  retrieve(query: RetrievalQuery): RetrievedEvidence[] {
    return retrieveCorpus(query.article, query.now);
  }
}
