...
import { applyReplacement, rebaseFindingsAfterAccept } from "@/lib/server/span-rebase";
import { fieldText } from "@/lib/server/span-locator";
...
function canTransition(status: FindingStatus, action: FindingAction): boolean {
  if (action === "accept") {
