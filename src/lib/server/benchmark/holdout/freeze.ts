...
import { DEEPSEEK_RETRY_POLICY } from "@/lib/server/llm/deepseek-review-model";
...
export const FREEZE_ASSET_PATHS = [
  "src/lib/server/llm/prompt.ts",
  "src/lib/contracts/review.ts",
  "data/rules/catalog.json",
  "data/corpus/references.json",
  "src/lib/server/benchmark/evaluate.ts",
  "src/lib/server/quality/rules.ts",
  "src/lib/server/quality/retrieval.ts",
  "src/lib/server/quality/fusion.ts",
  "src/lib/server/quality/ranking.ts",
  "src/lib/server/quality/evidence.ts",
  "src/lib/server/quality/severity.ts",
  "src/lib/server/quality/corpus.ts",
  "src/lib/server/quality/versions.ts",
  "src/lib/server/span-locator.ts",
  "src/lib/server/review-service.ts",
  "src/lib/server/llm/deepseek-review-model.ts",
  "src/lib/server/llm/openai-review-model.ts",
